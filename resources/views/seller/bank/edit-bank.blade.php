...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><i class="fas fa-university"></i> Edit Bank</div>
                      ...
                      <input type="hidden" name="id" value="{{ $bank->id }}">
                       ...
                       <div class="form-group row">
                           <div class="col-md-8">
                               ...
                               <input type="number" name="rekening" class="form-control" value="{{ $bank->rekening }}">
                               @error('rekening')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                    </span>
                       ...
                       <div class="form-group row">
                           <div class="col-md-8">
                               ...
                               <input type="text" name="holder" class="form-control" value="{{ $bank->holder }}">
                               @error('holder')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                    </span>
