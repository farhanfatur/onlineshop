...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Update Staff') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('updateStaff') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" required value="{{ $staff->address }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="number" class="form-control @error('phone') is-invalid @enderror" name="phone" required value="{{ $staff->phone }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="datebirth" type="date" class="form-control @error('datebirth') is-invalid @enderror" name="datebirth" required value="{{ $staff->datebirth }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-10 col-form-label text-md-right">
                                <span class="text-danger">* If you don't want edit password, empty the field</span>
                            </label>
                        </div>
